...
const meteorologyData = [
...

    {
        ...
        year: 2025,
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-00-DoM-Rainfall-Forecast-Seasonal-and-Monthly-Data.csv")), // Store CSV as binary
            png2: readImage(path.join(__dirname, "dbAssets/2025-09", "2025-09-00-DoM-Rainfall-Forecast-Seasonal.png")), // Store image as Buffer
        },
    },
    {
        department: "DoM",
        ...
        year: 2025,
        content: {
            png1: readImage(path.join(__dirname, "dbAssets/2025-09", "2025-09-00-DoM-Rainfall-Forecast-Monthly1.png")), // Store image as Buffer
        },
    },
    {
        department: "DoM",
        ...
        year: 2025,
        content: {
            png1: readImage(path.join(__dirname, "dbAssets/2025-09", "2025-09-00-DoM-Rainfall-Forecast-Monthly2.png")), // Store image as Buffer
        },
    },
    {
        department: "DoM",
        ...
        year: 2025,
        content: {
            png1: readImage(path.join(__dirname, "dbAssets/2025-09", "2025-09-00-DoM-Rainfall-Forecast-Monthly3.png")), // Store image as Buffer
        },
    },
    {
        department: "DoM",
    ...
    },
    {
        ...
        year: 2025,
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-00-DoM-Observed-Rainfall-Anomaly-Data.csv")), // Store CSV as binary
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoM-Received-Monthly-Rainfall.png')),
            png2: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoM-Observed-Percent-of-Normal-Precipitation.png')),
        },
    },
    {
        department: "DoM",
        ...
        district: "Kurunegala",
        content: {
            text: readTextFile(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoA-Agromet-Advisory-Summary-KUR-E.txt')),
        },
    },
    {
        department: "DoM",
        ...
        district: "Kurunegala",
        content: {
            text: readTextFile(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoA-Agromet-Advisory-Summary-KUR-S.txt')),
        },
    },
    {
        department: "DoM",
        ...
        content: {
            text: readTextFile(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoA-Agromet-Advisory-Summary-ANU-E.txt')),
        },
    },
    {
        department: "DoM",
        ...
        district: "Anuradhapura",
        content: {
            text: readTextFile(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoA-Agromet-Advisory-Summary-ANU-S.txt')),
        },
    },
    {
        department: "DoM",
        ...
        content: {
            text: readTextFile(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoA-Agromet-Advisory-Summary-TRI-E.txt')),
        },
    },
    {
        department: "DoM",
        ...
        district: "Trincomalee",
        content: {
            text: readTextFile(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoA-Agromet-Advisory-Summary-TRI-S.txt')),
        },
    },
    {
        department: "DoM",
        ...
        district: "Trincomalee",
        content: {
            text: readTextFile(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DoA-Agromet-Advisory-Summary-TRI-T.txt')),
        },
    },
    {
        department: "ID",
        ...
        district: "Anuradhapura",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Major-ANU.csv")),
        },
    },
    {
        department: "ID",
        ...
        district: "Kurunegala",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Major-KUR.csv")),
        },
    },
    {
        department: "ID",
        ...
        district: "Mannar",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Major-MAN.csv")),
        },
    },
    {
        department: "ID",
        ...
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Major-POL.csv")),
        },
    },
    {
        department: "ID",
        ...
        district: "Puttalam",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Major-PUT.csv")),
        },
    },
    {
        department: "ID",
        ...
        district: "Trincomalee",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Major-TRI.csv")),
        },
    },
    {
        department: "ID",
        ...
        district: "Vavuniya",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Major-VAV.csv")),
        },
    },
    {
        department: "ID",
        ...
        district: "Anuradhapura",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Medium-ANU.csv")),
            //csv2: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-PID-Reservoir-Water-Availability-Data-Medium.csv")),
        },
    },
    {
        ...
        district: "Kurunegala",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Medium-KUR.csv")),
            //csv2: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-PID-Reservoir-Water-Availability-Data-Medium.csv")),
        },
    },
    {
        ...
        district: "Mannar",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Medium-MAN.csv")),
            //csv2: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-PID-Reservoir-Water-Availability-Data-Medium.csv")),
        },
    },
    {
        ...
        district: "Polonnaruwa",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Medium-POL.csv")),
            //csv2: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-PID-Reservoir-Water-Availability-Data-Medium.csv")),
        },
    },
    {
        ...
        district: "Puttalam",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Medium-PUT.csv")),
            //csv2: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-PID-Reservoir-Water-Availability-Data-Medium.csv")),
        },
    },
    {
        ...
        district: "Trincomalee",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Medium-TRI.csv")),
            //csv2: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-PID-Reservoir-Water-Availability-Data-Medium.csv")),
        },
    },
    {
        ...
        district: "Vavuniya",
        content: {
            csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/2025-09", "2025-09-15-ID-Reservoir-Water-Availability-Data-Medium-VAV.csv")),
            //csv2: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-PID-Reservoir-Water-Availability-Data-Medium.csv")),
        },
    },
    {
    ...
    },
    {
        ...
        content: {
            //csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-DAD-Reservoir-Water-Availability-Data-Small.csv")),
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DAD-Water-Availability-Forecast-Minor-Tank-ANU.png')),
        },
    },
    {
        department: "DAD",
        ...
        content: {
            //csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-DAD-Reservoir-Water-Availability-Data-Small.csv")),
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DAD-Water-Availability-Forecast-Minor-Tank-KUR.png')),
        },
    },
    {
        department: "DAD",
        ...
        content: {
            //csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-DAD-Reservoir-Water-Availability-Data-Small.csv")),
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DAD-Water-Availability-Forecast-Minor-Tank-MAN.png')),
        },
    },
    {
        department: "DAD",
        ...
        content: {
            //csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-DAD-Reservoir-Water-Availability-Data-Small.csv")),
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DAD-Water-Availability-Forecast-Minor-Tank-POL.png')),
        },
    },
    {
        department: "DAD",
        ...
        content: {
            //csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-DAD-Reservoir-Water-Availability-Data-Small.csv")),
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DAD-Water-Availability-Forecast-Minor-Tank-PUT.png')),
        },
    },
    {
        department: "DAD",
        ...
        content: {
            //csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-DAD-Reservoir-Water-Availability-Data-Small.csv")),
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DAD-Water-Availability-Forecast-Minor-Tank-TRI.png')),
        },
    },
    {
        department: "DAD",
        ...
        content: {
            //csv1: readCsvAsBinary(path.join(__dirname, "dbAssets/KUR", "2025-08-31-DAD-Reservoir-Water-Availability-Data-Small.csv")),
            png1: readImage(path.join(__dirname, 'dbAssets/2025-09', '2025-09-00-DAD-Water-Availability-Forecast-Minor-Tank-VAV.png')),
        },
    },
